...
export class Header {
	...
	generateHeader(
		...
		titleDiv.addClass("title-div", "llm-flex");
		...
		leftButtonDiv.addClass("one", "left-buttons-div", "llm-flex");
		rightButtonsDiv.addClass("one", "right-buttons-div", "llm-flex");
		titleContainer.addClass("four", "title", "llm-flex");
